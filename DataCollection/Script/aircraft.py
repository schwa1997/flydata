...
def convert_aircraft_to_csv():
    ...
    input_file = f'{BASE_PATH_ORIGINAL}/aircraft.txt'
    ...
    try:
        with open(input_file, 'r', encoding='utf-8') as txt_file:
            ...
            with open(output_file, 'w', newline='', encoding='utf-8') as csv_file:
                ...
                writer.writerow(['AircraftID', 'ModelCode','AircraftType','RegisterCity',])
                ...
                for i, line in enumerate(lines):
                    ...
                    aircraft_type = line[248:249].strip()
                    register_city = line[177:195].strip()               
                    # Remove the commas from the extracted fields
                    n_number = 'N' + n_number
                    writer.writerow([n_number, model_code,aircraft_type,register_city])
